...
const amountAUTDesired = web3.utils.toWei(getCliArg('amountAUTDesired'), 'ether');
...
async function addLiquidity (router, tokenA_address, tokenB_address, amountADesired, amountBDesired, amountAMin, amountBMin, myAddress, deadline){

    const transfer = await router.methods.addLiquidity(tokenA_address, tokenB_address, amountADesired, amountBDesired, amountAMin, amountBMin, myAddress, deadline).call({
        from: myAddress,
        gas: 10000000
    });
    ...
    try {
        await router.methods.addLiquidity(tokenA_address, tokenB_address, amountADesired, amountBDesired, amountAMin, amountBMin, myAddress, deadline).send({
            from: myAddress,
            gas: 10000000
        })
        .on('transactionHash', function (hash) {
        ...
        await router.methods.addLiquidity(tokenA_address, tokenB_address, amountADesired, amountBDesired, amountAMin, amountBMin, myAddress, deadline).call({
            from: myAddress,
            gas: 10000000
        });
    }
...
async function addLiquidityETH (router, token_address, amountTDesired, amountAUTDesired, amountTMin, amountAUTMin, myAddress, deadline){
    
    const transfer = await router.methods.addLiquidityETH(token_address, amountTDesired, amountTMin, amountAUTMin, myAddress, deadline).call({
        from: myAddress,
        gas: 10000000,
    ...
    try {
        ...
        await router.methods.addLiquidityETH(token_address, amountTDesired, amountTMin, amountAUTMin, myAddress, deadline).send({
            from: myAddress,
            gas: 10000000,
            value: amountAUTDesired
        })
        ...
        await router.methods.addLiquidityETH(token_address, amountTDesired, amountTMin, amountAUTMin, myAddress, deadline).call({
            from: myAddress,
            gas: 10000000,
            value: amountAUTDesired
...
async function removeLiquidity (router, tokenA_address, tokenB_address, liquidity, amountAMin, amountBMin, myAddress, deadline){

    const transfer = await router.methods.removeLiquidity(tokenA_address, tokenB_address, liquidity, amountAMin, amountBMin, myAddress, deadline).call({
        from: myAddress,
        gas: 10000000
    })
    ...
    try {
        await router.methods.removeLiquidity(tokenA_address, tokenB_address, liquidity, amountAMin, amountBMin, myAddress, deadline).send({
            from: myAddress,
            gas: 10000000
        })
        .on('transactionHash', function (hash) {
        ...
        await router.methods.removeLiquidity(tokenA_address, tokenB_address, liquidity, amountAMin, amountBMin, myAddress, deadline).call({
            from: myAddress,
            gas: 10000000
        });
    }
...
async function removeLiquidityETH (router, token_address, liquidity, amountTMin, amountAUTMin, myAddress, deadline){

    const transfer = await router.methods.removeLiquidityETH(token_address, liquidity, amountTMin, amountAUTMin, myAddress, deadline).call({
        from: myAddress,
        gas: 10000000
    })
    ...
    try {
        await router.methods.removeLiquidityETH(token_address, liquidity, amountTMin, amountAUTMin, myAddress, deadline).send({
            from: myAddress,
            gas: 10000000
        })
        .on('transactionHash', function (hash) {
        ...
        await router.methods.removeLiquidityETH(token_address, liquidity, amountTMin, amountAUTMin, myAddress, deadline).call({
            from: myAddress,
            gas: 10000000
        });
    }
...
async function main() {
    ...
    const pairAB_address = await factory.methods.getPair(tokenA_address, tokenB_address).call({ from: myAddress, gas: 10000000});
    const pairAB = new web3.eth.Contract(Pair.abi, pairAB_address);

    const pairAAUT_address = await factory.methods.getPair(tokenA_address, weth_address).call({ from: myAddress, gas: 10000000});
    const pairAAUT = new web3.eth.Contract(Pair.abi, pairAAUT_address);

    const pairBAUT_address = await factory.methods.getPair(tokenB_address, weth_address).call({ from: myAddress, gas: 10000000});
    ...
    if (fund_pair == '0'||fund_pair ==  '1'||fund_pair ==  '2'){  // Only do approvals that are needed to save time
    ...
    if (defund_pair == '0' ||defund_pair ==  '1' ||defund_pair ==  '2'){  // Only do approvals that are needed to save time
    ...
    if (fund_pair == '0'){
        ...
        await addLiquidity (router, tokenA_address, tokenB_address, amountADesired, amountBDesired, amountAMin, amountBMin, myAddress, deadline);
    
    } else if (fund_pair == '1'){
        console.log ('Add liquidity to tokenA-AUT pair');
        await addLiquidityETH (router, tokenA_address, amountADesired, amountAUTDesired, amountAMin, amountAUTMin, myAddress, deadline);

    } else if (fund_pair == '2'){
        console.log ('Add liquidity to tokenB-AUT pair');
        await addLiquidityETH (router, tokenB_address, amountBDesired, amountAUTDesired, amountBMin, amountAUTMin, myAddress, deadline);
    ...
    if (defund_pair == '0'){
        ...
        await removeLiquidity (router, tokenA_address, tokenB_address, liquidity, amountAMin, amountBMin, myAddress, deadline);

    } else if (defund_pair == '1'){
        console.log ('Remove liquidity from tokenA-AUT pair');
        removeLiquidityETH (router, tokenA_address, liquidity, amountAMin, amountAUTMin, myAddress, deadline)

    } else if (defund_pair == '2'){
        console.log ('Remove liquidity from tokenB-AUT pair');
        removeLiquidityETH (router, tokenB_address, liquidity, amountBMin, amountAUTMin, myAddress, deadline)
