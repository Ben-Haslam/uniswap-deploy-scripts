...
async function ExactTokensForTokens(
  router,
  amountIn,
  amountOutMin,
  tokenA_address,
  ...
  try {
    ...
    console.log(
      "the swapExactTokensForTokens transaction reverted! Lets see why..."
    );
...
async function TokensForExactTokens(
  router,
  amountInMax,
  amountOut,
  tokenA_address,
  ...
  try {
    ...
    console.log(
      "the swapTokensForExactTokens transaction reverted! Lets see why..."
    );
...
async function ExactETHForTokens(
  router,
  amountIn,
  amountOutMin,
  tokenA_address,
  ...
  const transfer = await router.methods
    .swapExactETHForTokens(amountOutMin, tokens, myAddress, deadline)
    .call({
      from: myAddress,
      gas: 10000000,
      value: amountIn,
  ...
  try {
    ...
    console.log(
      "the swapExactETHForTokens transaction reverted! Lets see why..."
    );
...
async function ETHForExactTokens(
  router,
  amountInMax,
  amountOut,
  tokenA_address,
  ...
  const transfer = await router.methods
    .swapETHForExactTokens(amountOut, tokens, myAddress, deadline)
    .call({
      from: myAddress,
      gas: 10000000,
      value: amountInMax,
  ...
  try {
    ...
    console.log(
      "the swapETHForExactTokens transaction reverted! Lets see why..."
    );
...
async function ExactTokensForETH(
  router,
  amountIn,
  amountOutMin,
  tokenA_address,
  ...
  const transfer = await router.methods
    .swapExactTokensForETH(amountIn, amountOutMin, tokens, myAddress, deadline)
    .call({
      from: myAddress,
      gas: 10000000,
    });
  ...
  try {
    ...
    console.log(
      "the swapExactTokensForETH transaction reverted! Lets see why..."
    );
...
async function TokensForExactETH(
  router,
  amountInMax,
  amountOut,
  tokenA_address,
  ...
  const transfer = await router.methods
    .swapTokensForExactETH(amountOut, amountInMax, tokens, myAddress, deadline)
    .call({
      from: myAddress,
      gas: 10000000,
    });
  ...
  try {
    ...
    console.log(
      "the swapTokensForExactETH transaction reverted! Lets see why..."
    );
...
async function getAmountsOut(
  ...
  const amount_out = await router.methods
  ...
  console.log(
    "amount in of ",
    token0,
    web3.utils.fromWei(amount_out[0], "ether")
  );
  console.log(
    "amount out of ",
    token1,
    web3.utils.fromWei(amount_out[1], "ether")
  );
  console.log(
    "amount out of ",
    token2,
    web3.utils.fromWei(amount_out[2], "ether")
  );
  console.log("----------------------");
}
...
async function getAmountsIn(
  ...
  const amount_in = await router.methods
    .getAmountsIn(amountOut, tokens)
    .call({ from: myAddress, gas: 10000000 });

  console.log(
    "amount out of ",
    token2,
    web3.utils.fromWei(amount_in[2], "ether")
  );
  console.log(
    "amount in of ",
    token0,
    web3.utils.fromWei(amount_in[0], "ether")
  );
  console.log(
    "amount in of ",
    token1,
    web3.utils.fromWei(amount_in[1], "ether")
  );
  console.log("----------------------");
}
...
async function test() {
  ...
  if (which_quote == 0) {
    ...
    console.log(
      "That number is not an option, if you want to quote please select quote function 0-1."
    );
  }
  ...
  if (which_swap == 0) {
    ...
    console.log(
      "That number is not an option, if you want to make a swap please select swap function 0-5."
    );
  }
}
